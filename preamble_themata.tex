...
\fancypagestyle{vangelis}{\fancyhf{}
  \lfoot{\small \vspace{3pt}\color{Col1} Ευάγγελος Σαπουνάκης}
  \cfoot{\small \vspace{3pt}\color{Col2!75} MoreMath}
\rfoot{\small \vspace{3pt} \thepage}}
\fancypagestyle{askhseis}{\fancyhf{}
  \lfoot{\small \vspace{3pt}\color{Col1} Φοιτητικό Πρόσημο}
  \cfoot{\small \vspace{3pt}\color{Col2!75}}
\rfoot{\small \vspace{3pt} \thepage}}
\fancypagestyle{vang}{\fancyhf{}
  \lfoot{\small \vspace{3pt}\color{Col1} Ευάγγελος Σαπουνάκης Msc}
  \cfoot{\small \vspace{3pt}\color{Col2!75}}
\rfoot{\small \vspace{3pt} \thepage}}
...
% the ref command
%use \ref or \zhref for hyperlink
\usepackage{nameref}
...
\usepackage{geometry}
\geometry{left=20.63mm,right=20.63mm,top=30.25mm,bottom=30.25mm,footskip=24.16mm,headsep=24.16mm}
...
\newtheorem{remsbreak}[thm]{Παρατηρήσεις}
...
\newtheorem{thema}[thm]{Θέμα}
\newtheorem{themata}[thm]{Θέματα}
