...
% section format
\titleformat{\section}%
{\normalfont\Large\bfseries\itshape\color{Col1!85}}% format applied to label+text
...
{\normalfont\large\bfseries\itshape\color{Col1!65}}% format applied to label+text
