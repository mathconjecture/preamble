...
% \usepackage{libertinus-otf}
  ...
  \setmainfont[Path=$HOME/.fonts/,Extension=.ttf,UprightFont=*-Regular,BoldFont=*-Bold,ItalicFont=*-Italic, BoldItalicFont=*-Bold-Italic]{Minion-Pro}
  \setsansfont[Path=$HOME/.fonts/,Extension=.ttf,UprightFont=*H,BoldFont=*HB,ItalicFont=*HI, BoldItalicFont=*HBI]{Vera}
