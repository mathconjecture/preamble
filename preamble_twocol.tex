...
\usepackage{geometry}
\geometry{left=1cm,right=1cm,top=1cm,bottom=35mm,footskip=24.16mm,headsep=24.16mm}
...
%%%%%%%%%%%%Watermark%%%%%%%%%%%%%%%%%%
 ...
 \newwatermark[allpages,color=Col2!8,angle=45,scale=3,xpos=0,ypos=0]{ΠΡΟΣΗΜΟ}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
