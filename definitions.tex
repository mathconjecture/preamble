...
\newcommand{\twocolumnsidel}[2]{\begin{minipage}[t]{0.27\linewidth}\raggedright
        #1
        \end{minipage}\hfill{\color{Col\thechapter}{\vrule width 1pt}}\hfill\begin{minipage}[t]{0.68\linewidth}\raggedright
        #2
    \end{minipage}
}
