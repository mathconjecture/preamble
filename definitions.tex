...
\setlist[myitemize,2]{label=\textcolor{Col1}{\small$\blacktriangleright$}}
% \setlist[myitemize]{label=\textcolor{Col1}{$\small\blacktriangleright$}}
...
\newcommand{\twocolumnsidelc}[2]{\begin{minipage}[c]{0.25\linewidth}\raggedright
        #1
...
\newcommand{\twocolumnsiderc}[2]{\begin{minipage}[c]{0.70\linewidth}\raggedright
        #1
        \end{minipage}\hfill\begin{minipage}[c]{0.25\linewidth}\raggedright
        #2
    \end{minipage}
}
...
\newcommand{\threecolumnsides}[3]{\begin{minipage}[c]{0.30\linewidth}\raggedright
        #1
