...
% \usepackage{geometry}
% \geometry{left=15mm,right=15mm,top=25mm,bottom=25mm,footskip=24.16mm,headsep=24.16mm}
...
%%%%%%%%%%%%Watermark%%%%%%%%%%%%%%%%%%
 \usepackage[printwatermark]{xwatermark} 
 \newwatermark[allpages,fontfamily=lmr,fontseries=m,color=Col2!20,angle=45,scale=4]{ΠΡΟΣΗΜΟ}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
