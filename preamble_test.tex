...
\setmainfont[Path=$HOME/.fonts/GFS_Didot/GFS_Didot/,UprightFont=*,BoldFont=*Bold,ItalicFont=*italic,BoldItalicFont=*Bolditalic,Extension=.otf]{GFSDidot}

  % \setmathfont(Digits,Latin,Greek)[STIX2Math.otf]
